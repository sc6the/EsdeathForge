...
public class FPS extends Module {
   ...
   public FPS() {
      super("FPS", "FPS", Category.VISUAL, true);
   }
   ...
   public void OnRender(EventRender var1) {
      ...
      var3.drawStringWithShadow(String.valueOf(Minecraft.getDebugFPS()), var2.getX(), var2.getY(), EsdeathClient.getInstance().rainbow(500));
   }
