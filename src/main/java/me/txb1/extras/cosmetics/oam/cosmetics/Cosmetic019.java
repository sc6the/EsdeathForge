...
@CosmeticInfo(id=19, height=0.0, activatergb=false, displayname="Youtube", type=CosmeticType.EXCLUSIVE)
public class Cosmetic019
extends CosmeticModelRenderer {
    CosmeticModelRenderer socialmediasign;

    public Cosmetic019(ModelBase base) {
        super(base);
    ...
    public void render(float scale) {
        this.bindCosmeticTexture("youtube-sign.png");
        GL11.glPushMatrix();
        if (this.isSneaking()) {
